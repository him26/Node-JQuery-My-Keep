 ...
 */
 ...
 console.log(tit);
   ...
   // var dfg =  '#outputbox'+i;
   // console.log(dfg);
 var div = $("<div class='col-lg-12' id='start'><br><div class='card'><div class='title' id=" + tit + "></div><div id='content'><div class='insidecontent' id="+ con +"></div></div></div>").appendTo('#outputbox');
 var border = div.css('border','1px solid black').css('word-wrap','break-word').css('display','inline-block');
console.log(border);
       // var height = $('#inputbox1').height();
       // var width =  $('#outputbox').width();
       // var w = width/3;
       // console.log(height);
       // console.log(w);
//                         var div = $("<div class='' id=''><div class='card-2'><div class='title' id=" + tit + "></div><div id='content'><div class='insidecontent' id="+ con +"></div></div></div>").appendTo("#outputbox");
// // console.log(div);
//                         var border = div.css('border','1px solid black').css('word-wrap','break-word').css('width','400px').css('display','inline-block').css('position','relative');
